    ...
    application = tornado.web.Application(
        [
            ...
            (r"/connections/([0-9]+)", ItemsHandler,
             dict(items = appModel.connections)),
            (r"/inputs", ItemsHandler, 
             dict(items = appModel.inputs)),
            (r"/inputs/([0-9]+)", ItemsHandler,
             dict(items = appModel.inputs)),
            (r"/outputs", ItemsHandler, 
             dict(items = appModel.outputs)),
            (r"/outputs/([0-9]+)", ItemsHandler,
             dict(items = appModel.outputs)),
            ...
            (r"/views/([0-9]+)", ItemsHandler,
             dict(items = appModel.views)),
            (r"/inputObservers", ItemsHandler, 
             dict(items = appModel.inputObservers)),
            (r"/inputObservers/([0-9]+)", ItemsHandler,
             dict(items = appModel.inputObservers)),
